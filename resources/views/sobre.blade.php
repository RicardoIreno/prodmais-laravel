...
@section('title', 'Sobre o software Prodmais')
...
M75.6,75.1V58.2h16.9v16.4c-0.2,0.1-0.4,0.3-0.5,0.5H75.6z" />
    ...
    <section class="p-about-section2">
        ...
        <div class="p-about-team">
            ...
            <a href='http://lattes.cnpq.br/2259956816336032' class='c-who' target='blank' />
            <img class='c-who-photo u-grayscale'
                src="http://servicosweb.cnpq.br/wspessoa/servletrecuperafoto?tipo=1&id=K4525821T0" />
            <div class='c-who-text'>
                <b>Lidiane Cristina da Silva</b>
                <b class='c-who-title'>Superintendente da TI</b>
            </div>
            </a>

            <a href='http://lattes.cnpq.br/6792408436784536' class='c-who' target='blank' />
            <img class='c-who-photo u-grayscale' src="https://souciencia.unifesp.br/images/equipe/Alexsandro.jpeg" />
            <div class='c-who-text'>
                <b>Alexandro Cardoso Carvalho</b>
                <b class='c-who-title'>Chefe da Divisão de Gestão da Informação</b>
            </div>
            </a>
            ...
            <div class='c-who-text'>
                ...
                <b class='c-who-title'>Bolsista FAP UNIFESP</b>
            </div>
            </a>

            <a href='http://lattes.cnpq.br/8604973833723919' class='c-who' target='blank' />
            <img class='c-who-photo u-grayscale'
                src="https://servicosweb.cnpq.br/wspessoa/servletrecuperafoto?tipo=1&id=K1702294J9" />
            <div class='c-who-text'>
                <b>Ricardo Ireno dos Santos</b>
                <b class='c-who-title'>Bolsista FAP UNIFESP</b>
            </div>
            </a>
